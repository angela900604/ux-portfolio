/**
 * Cormorant Garamond stack — use **only** with inline `style={{ fontFamily: … }}` on these lines:
 * - Left rail: “Hi, I'm Angela.” ({@link MARKETING_FLAGSHIP_SERIF_LEAD_CLASS})
 ...
 *
 * Everything else should use Inter (`font-sans` / body).
 */
...
export const MARKETING_FLAGSHIP_SERIF_LEAD_CLASS =
  "text-[clamp(1.5rem,2.8vw,2.25rem)] font-normal leading-[1.12] tracking-[-0.02em] text-ink";
...
export const MARKETING_FLAGSHIP_SERIF_LEAD_COMPACT_CLASS =
  "text-[clamp(1.375rem,2.45vw,2.0625rem)] font-normal leading-[1.12] tracking-[-0.02em] text-ink";

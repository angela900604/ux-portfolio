...
export function GovernmentBackendEngineeringAlignment() {
  return (
    <div className="w-full space-y-6">
      <h2 className="max-w-3xl text-lg font-semibold leading-snug tracking-tight text-ink sm:text-xl">
        How I aligned design with engineering
      </h2>

      <figure className="space-y-4">
        <p className="max-w-3xl text-sm leading-relaxed text-ink-soft sm:text-[15px]">

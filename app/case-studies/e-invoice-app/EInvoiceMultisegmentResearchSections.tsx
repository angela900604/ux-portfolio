    ...
    >
      <div className="min-w-0 max-w-3xl space-y-4">
        <div className="flex flex-wrap items-center gap-2">
          <span className="inline-flex rounded-full bg-zinc-900/40 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-zinc-100">
            {badge}
          </span>
          {segments.map((seg) => (
            <span
        ...
        {quotes.map((q, i) => {
          const quoteClasses =
            q.quoteStyle === "synthesis"
              ...
              : "text-sm italic leading-relaxed text-zinc-300 sm:text-base";
          return (
            <figure
              key={i}
              className="border-l-2 border-zinc-800 pl-4 pt-1"
            >

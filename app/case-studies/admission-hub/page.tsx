    ...
    <article className="min-h-screen">
      ...
      >
        <Section id="strategy" kicker="01 · Strategy">
          ...
          <figure className="mt-10 bg-zinc-900/40/25">
            <ImageLightbox
        ...
        >
          ...
          <div className="mt-10 rounded-xl border border-zinc-800 bg-zinc-900/40 p-6">
            ...
            <figure className="mt-6 bg-zinc-900/40">
              <ImageLightbox
        ...
        >
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2 sm:gap-3">
            <span className="inline-flex items-center rounded-full border border-zinc-800 bg-zinc-900/40 px-4 py-2 text-sm font-medium tabular-nums text-zinc-100">
              ~5 likes

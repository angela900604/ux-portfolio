...
const WEBM = "/case-studies/mina/mina-cover.webm";
const MP4 = "/case-studies/mina/mina-cover.mp4";
const POSTER = "/case-studies/mina/mina-ai-hero.png";

/**
 * Homepage MINA card media: WebM + MP4, plays when the card enters the viewport.
 */
export function MinaHomeProjectCover() {

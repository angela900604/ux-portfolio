import { WideFigure } from "@/app/case-studies/e-invoice-app/EInvoiceFigures";
import { SketchPersonasExpandable } from "@/app/case-studies/e-invoice-app/SketchPersonasExpandable";
...
/** Frozen research body for /multisegment-interviews only (decoupled from the e-invoice case study). */
export function MultisegmentInterviewsResearchBody() {
  return (
        ...
        <div className="space-y-5">
              ...
              <tbody className="divide-y divide-zinc-800 text-zinc-300">
                <tr className="align-top">
                  ...
                  <td className="px-3 py-3.5 text-zinc-200" colSpan={5}>
                    ...
                    — universal: paper receipt, QR on screen, or prize check—all
                    roads led to scan first.
                  </td>
                </tr>
                <tr className="align-top">
                  <th className="px-3 py-3.5 text-left text-xs font-medium uppercase tracking-wide text-zinc-400">
          ...
          <div className="rounded-xl border border-emerald-500/25 bg-emerald-500/[0.06] px-5 py-4 text-sm leading-relaxed text-zinc-300">
            ...
            <p className="mt-2 text-zinc-100">
              Everyone converged on the same entry behavior: show the carrier
              barcode and scan paper invoices.
            </p>
            <p className="mt-3">
              On the home screen,{" "}
